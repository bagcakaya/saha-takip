                        ...
                        >
                          ...
                          {isAdmin && (
                            <td className="py-3 px-3 text-center whitespace-nowrap">
                              ...
                              ) : (record.checkOutOutside && record.checkOutApprovalStatus === 'approved') || (record.checkInOutside && record.checkInApprovalStatus === 'approved') ? (
                              ...
                              ) : (record.checkOutOutside && record.checkOutApprovalStatus === 'rejected') || (record.checkInOutside && record.checkInApprovalStatus === 'rejected') ? (
