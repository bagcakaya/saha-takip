...
export const ReturnWarrantyModal: React.FC<ReturnWarrantyModalProps> = ({
  ...
  useEffect(() => {
    if (editingItem) {
      ...
      setCariName(editingItem.cariName || '');
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 max-h-[80vh] overflow-y-auto pr-1">
        ...
        {/* Company Name */}
        <div>
          <label className="block text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-1.5">
            <Building2 className="w-3.5 h-3.5 text-blue-500" />
