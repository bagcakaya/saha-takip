...
import { X, XCircle, MapPin, UserCheck, AlertTriangle } from 'lucide-react';
import { LocationItem } from '../../types/storage';

interface RejectLocationModalProps {
  isOpen: boolean;
...
export const RejectLocationModal: React.FC<RejectLocationModalProps> = ({
  isOpen,
  location,
  onClose,
  onConfirm,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Kurulumun onaylanmadığını personele gerekçesiyle iletin.
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Örn: 3. ve 5. görevler tam yapılmamış, saha fotoğrafları yüklenmemiş..."
              rows={3}
              required
            ...
            <p className="text-[11px] text-slate-400">
              Bu gerekçe personele anında bildirim olarak gönderilecek ve kurulum kartında kırmızı uyarı olarak görüntülenecektir.
            </p>
          </div>
