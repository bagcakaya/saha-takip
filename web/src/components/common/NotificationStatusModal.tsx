  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200 overflow-y-auto">
      <div className="w-full max-w-lg bg-white dark:bg-slate-850 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden my-6 animate-in zoom-in-95 duration-150">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Kilit ekranı bildirimlerinin kalıcı çalışmasını sağlar
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 space-y-4 max-h-[78vh] overflow-y-auto">
          ...
          {/* CRITICAL ANDROID INSTRUCTION BOX (Addresses Görsel-3 and Görsel-4 directly) */}
          <div className="p-4 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/80 space-y-3 text-xs">
            ...
            <div className="space-y-2.5 text-slate-700 dark:text-slate-300 leading-relaxed text-[11px]">
