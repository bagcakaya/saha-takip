...
export const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <>
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-4 sm:p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-3.5 group max-w-full overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-2.5 min-w-0 w-full">
          <div className="min-w-0 flex-1 space-y-1">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <h3 className="text-base font-black text-slate-900 dark:text-slate-100 tracking-tight truncate min-w-0 flex-1">
                {service.companyName}
              </h3>
            </div>
