...
import { X, XCircle, Wrench, UserCheck, AlertTriangle } from 'lucide-react';
...
export const RejectServiceModal: React.FC<RejectServiceModalProps> = ({
  isOpen,
  service,
  onClose,
  onConfirm,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Servisin tamamlanmadığını personele gerekçesiyle iletin.
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Örn: Yapılan işlem detaylandırılmamış, servis fotoğrafları yüklenmemiş..."
              rows={3}
              required
            ...
            <p className="text-[11px] text-slate-400">
              Bu gerekçe personele anında bildirim olarak gönderilecek ve servis kartında kırmızı uyarı olarak görüntülenecektir.
            </p>
          </div>
